...
if(isset($_POST['updsimpan']))
{
	...
	$persgud	=$_POST['persediaangudang'];
	if($database->homeusrupd($kodebar,$newnambar,$persaw,$persgud))
	{
...
if(isset($_POST['newsimpan']))
{
	...
	$persaw		=$_POST['persediaanawal'];
	$persgud	=$_POST['persediaangudang'];
	if($database->homeusrnew($kodebar,$newnambar,$persaw,$persgud))
	{
	 header('location:homeusr.php');	
	}		
}
if(isset($_POST['remsimpan']))
{
	...
	if($database->homeusrrem($remnambar))
	{
	 header('location:homeusr.php');	
	}	
}
...
<main role="main" class="container">
  ...
  <div id="mainC" class="starter-template">
	...
	<br/><br/>
		...
		<! div buat template tabel versi user >
		<div id="tableUSR" class="tabelShow">	
			<!awal pembuatan tabel>
			<table width='85%' border=1>
 
			<tr>
			<th>Kode Barang</th> <th>Nama Barang</th> <th>Persediaan Awal</th> <th>Persediaan Gudang</th>
			</tr>
			<!looping buat ngambil data dari hasil left join barang & jumlah>
			<?php  
			while($data1 = mysqli_fetch_array($resultusr)) {         
				echo "<tr>";
				echo "<td>".$data1['kodebarang']."</td>";
				echo "<td>".$data1['namabarang']."</td>";
				echo "<td>".$data1['persediaanawal']."</td>"; 
				echo "<td>".$data1['persediaangudang']."</td>"; 		
				echo "</tr>";        
			}
			?>
			</table>
...
<div id="myModalNEW" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
	  ...
	  <label for="persediaangudang" class="sr-only">Persediaan Gudang:</label>
	  <input type="number" id="persediaangudang" class="form-control" placeholder="Persediaan Gudang" name="persediaangudang" required autofocus>
